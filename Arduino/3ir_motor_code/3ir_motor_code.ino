...
#define M_S A1//ir sensor Left
#define L_S A2//ir sensor Middle
...
void loop(){  
  if((digitalRead(L_S) == 1)&&(digitalRead(M_S)==0)&&(digitalRead(R_S) == 1)){
  ...
  if((digitalRead(L_S) == 0)&&(digitalRead(M_S)==0)&&(digitalRead(R_S) == 0)){
