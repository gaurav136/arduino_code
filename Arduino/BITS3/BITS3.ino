...
void loop()
{  
if((digitalRead(L_S) == 0) &&( digitalRead(M_S) == 0) &&(digitalRead(R_S) == 0)){turnLeft();}   
...
if((digitalRead(L_S) == 0) &&( digitalRead(M_S) == 0) &&(digitalRead(R_S) == 1)){turnLeft();}
...
if((digitalRead(L_S) == 0) &&( digitalRead(M_S) == 1) &&(digitalRead(R_S) == 1)){turnLeft();} 
// If all sensor are on black color ( juntion point) then it will turn left
  
if((digitalRead(L_S) == 1) &&( digitalRead(M_S) == 0) &&(digitalRead(R_S) == 0)){turnRight();} 
...
if((digitalRead(L_S) == 1) &&( digitalRead(M_S) == 1) &&(digitalRead(R_S) == 0)){turnRight();}

if((digitalRead(L_S) == 1) &&( digitalRead(M_S) == 1) &&(digitalRead(R_S) == 1)){Uturn();}
}
